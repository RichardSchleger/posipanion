...
import com.posipanion.MainActivity;
import com.posipanion.R;

import java.util.Date;

public class LocationUpdatesService extends Service {

    private static final String PACKAGE_NAME = "com.posipanion.location";

    private static final String TAG = LocationUpdatesService.class.getSimpleName();

    public static final String LOCATION_EVENT_NAME = "com.posipanion.LOCATION_INFO";
...
//         }
        ...
        LocationCoordinates locationCoordinates = createCoordinates(location.getLatitude(), location.getLongitude(), location.getAltitude());
        broadcastLocationReceived(locationCoordinates);
    }

    private LocationCoordinates createCoordinates(double latitude, double longitude, double altitude) {
