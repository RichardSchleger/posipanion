...
public class LocationModule extends ReactContextBaseJavaModule implements JSEventSender {
    ...
    private static final String CONST_JS_LOCATION_ALTI = "JS_LOCATION_ALTI_KEY";
    ...
    public static final String JS_LOCATION_ALTI_KEY = "altitude";
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put(CONST_JS_LOCATION_ALTI, JS_LOCATION_ALTI_KEY);
    ...
    public void createEventReceiver() {
        mEventReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                eventData.putDouble(JS_LOCATION_ALTI_KEY, locationCoordinates.getAltitude());
